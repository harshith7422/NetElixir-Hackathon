...
try:
    sessions = pd.read_csv('Data/merged_sessions.csv')
    user_features = pd.read_csv('Data/user_segments.csv')
    fallback_top_categories = pd.read_csv('Data/fallback_top_categories.csv')
except FileNotFoundError as e:
    print(f"Error: Data file not found - {e}. Please ensure 'merged_sessions.csv', 'user_segments.csv', and 'fallback_top_categories.csv' exist in the Data/ directory.")
    exit(1)
